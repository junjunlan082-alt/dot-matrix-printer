...
function searchLinks(links, keyword){
	...
	document.writeln("<meta NAME=\"Version\" CONTENT=\"BPS0138-01 SC\">");
	document.writeln("<title>搜索结果</title>");
	...
	document.writeln("<div class=\"extra-head\">搜索结果</div>");

	document.writeln("<div class=\"extra-text\">");
	document.writeln("搜索结果为 : <B>" +keyword.toUpperCase() +"</B>");
	...
	document.writeln("如果没有找到您想要的结果，查看搜索提示。");
	document.writeln("</div>");
	document.writeln("<div class=\"extra-link\">");
	
	document.writeln("<a href=\"javascript:goMain(\'sch.htm\')\">搜索提示</a>");
...
descArray[arraycount] = "设置"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "apspe_5.htm#S-00900-00500"
descArray[arraycount] = "清洁打印机"
	
arraycount += 1
	
namesArray[arraycount] = "客户机"
urlsArray[arraycount] = "soft_8.htm#S-00400-00600-00300"
descArray[arraycount] = "对于Windows 7, Vista, XP或 2000"
	
arraycount += 1
	
namesArray[arraycount] = "命令列表"
...
namesArray[arraycount] = ""
urlsArray[arraycount] = "custo_1.htm#S-00700-00200-00100"
descArray[arraycount] = "寻求帮助"
	
arraycount += 1
	
namesArray[arraycount] = "连续纸"
urlsArray[arraycount] = "paper_1.htm#S-00300-00300"
descArray[arraycount] = "打印"
	
arraycount += 1
	
namesArray[arraycount] = "连续纸"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00500"
descArray[arraycount] = "规格"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_1.htm#S-00500-00100"
descArray[arraycount] = "操作面板"
...
namesArray[arraycount] = "操作面板"
urlsArray[arraycount] = "cntrl_1.htm#S-00500-00100"
descArray[arraycount] = "指示灯"
	
arraycount += 1
	
namesArray[arraycount] = "操作面板"
urlsArray[arraycount] = "cntrl_1.htm#S-00500-00100"
descArray[arraycount] = "面板"
...
descArray[arraycount] = "数据长度"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00200"
descArray[arraycount] = "默认设置方式"
	
arraycount += 1
	
namesArray[arraycount] = "默认设置"
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100"
descArray[arraycount] = "选项列表"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "soft_2.htm#S-00400-00200"
descArray[arraycount] = "驱动程序（打印机驱动程序）"
	
arraycount += 1
	
namesArray[arraycount] = "信封"
...
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-02500"
descArray[arraycount] = "字体"
...
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-02200"
descArray[arraycount] = "斜体表国际字符集"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00200"
descArray[arraycount] = "国际字符集"
	
arraycount += 1
	
namesArray[arraycount] = "旋钮"
urlsArray[arraycount] = "trble_4.htm#S-00600-00600"
descArray[arraycount] = "打印机"
...
descArray[arraycount] = "打印纸调整"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "trble_4.htm#S-00600-00600"
descArray[arraycount] = "夹纸，清除"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00500"
descArray[arraycount] = "打印纸规格"
...
namesArray[arraycount] = "卷纸"
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-02600"
descArray[arraycount] = "卷纸"
...
namesArray[arraycount] = ""
urlsArray[arraycount] = "trble_5.htm#S-00600-00500"
descArray[arraycount] = "自检"
	
arraycount += 1
	
namesArray[arraycount] = "服务器"
urlsArray[arraycount] = "soft_8.htm#S-00400-00600-00200"
descArray[arraycount] = "对于Windows 7, Vista, XP或 2000"
	
arraycount += 1
	
namesArray[arraycount] = "单页纸"
...
descArray[arraycount] = "跳过页缝"
	
arraycount += 1
	
namesArray[arraycount] = "睡眠模式"
urlsArray[arraycount] = "cntrl_1.htm#S-00500-00100-00300"
descArray[arraycount] = "面板操作"
	
arraycount += 1
	
namesArray[arraycount] = "软件"
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-00700"
descArray[arraycount] = "默认设置"
	
arraycount += 1
	
namesArray[arraycount] = "规格"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00200"
descArray[arraycount] = "内置字体"
	
arraycount += 1
	
namesArray[arraycount] = "规格"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00200"
descArray[arraycount] = "字符表"
	
arraycount += 1
	
namesArray[arraycount] = "规格"
urlsArray[arraycount] = "apspe_3.htm#S-00900-00300-00100"
descArray[arraycount] = "命令列表"
...
descArray[arraycount] = "电气部分"
	
arraycount += 1
	
namesArray[arraycount] = "规格"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00200"
descArray[arraycount] = "电子部分"
	
arraycount += 1
	
namesArray[arraycount] = "规格"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00400"
descArray[arraycount] = "环境要求"
...
namesArray[arraycount] = "规格"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00100"
descArray[arraycount] = "机械部分"
	
arraycount += 1
	
namesArray[arraycount] = "规格"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00500"
descArray[arraycount] = "打印纸"
...
namesArray[arraycount] = "规格"
urlsArray[arraycount] = "apspe_2.htm#S-00900-00200-00600"
descArray[arraycount] = "推荐的可打印区域"
	
arraycount += 1
	
namesArray[arraycount] = "规格"
urlsArray[arraycount] = "apspe_4.htm#S-00900-00400"
descArray[arraycount] = "标准和认证"
...
namesArray[arraycount] = ""
urlsArray[arraycount] = "paper_1.htm#S-00300-00300-00600"
descArray[arraycount] = "切纸"
	
arraycount += 1
	
namesArray[arraycount] = "切纸"
urlsArray[arraycount] = "paper_1.htm#S-00300-00300-00600-00300"
descArray[arraycount] = "调整"
	
arraycount += 1
	
namesArray[arraycount] = "切纸"
urlsArray[arraycount] = "paper_1.htm#S-00300-00300-00600-00200"
descArray[arraycount] = "自动"
...
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-02700"
descArray[arraycount] = "运输打印机"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "apspe_6.htm#S-00900-00600"
descArray[arraycount] = "故障查找"
	
arraycount += 1
	
namesArray[arraycount] = "故障查找"
urlsArray[arraycount] = "trble_4.htm#S-00600-00600"
descArray[arraycount] = "清除夹纸"
	
arraycount += 1
	
namesArray[arraycount] = "故障查找"
urlsArray[arraycount] = "trble_3.htm#S-00600-00300"
descArray[arraycount] = "USB问题"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-00500"
descArray[arraycount] = "单方向打印(Uni-D)"
	
arraycount += 1
	
namesArray[arraycount] = "卸载"
urlsArray[arraycount] = "soft_10.htm#S-00400-00800"
descArray[arraycount] = "打印机软件"
	
arraycount += 1
	
namesArray[arraycount] = ""
urlsArray[arraycount] = "cntrl_3.htm#S-00500-00200-00100-00900"
descArray[arraycount] = "USB接口"
	
arraycount += 1
	
namesArray[arraycount] = "USB接口"
urlsArray[arraycount] = "trble_3.htm#S-00600-00300"
descArray[arraycount] = "问题"
...
document.write("<title>搜索结果</title><body bgcolor=white>");
